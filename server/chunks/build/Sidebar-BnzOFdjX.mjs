...
import { _ as _sfc_main$3, a as _sfc_main$2$1, b as _sfc_main$1$1, c as _sfc_main$5 } from './DropdownMenuItem-bkfc8fNQ.mjs';
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, renderSlot, useSSRContext } from 'vue';
...
import { _ as _sfc_main$4, c as cn } from './index-DXIlBIYA.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiDropdownMenu = _sfc_main$3;
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex bg-white" }, _attrs))}><header class="max-w-[2048px] font-medium text-black/70 w-full mx-[auto] z-10 sticky top-0 h-14 flex justify-between items-center gap-10 border-b bg-background px-4 md:px-6"><nav class="flex gap-10 text-sm"><!--[-->`);
      ...
      _push(`<!--]--></nav><div class="ml-[auto] mr-4">`);
...
//# sourceMappingURL=Sidebar-BnzOFdjX.mjs.map
