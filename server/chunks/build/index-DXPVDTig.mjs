import { _ as _sfc_main$a } from './Sidebar-BTa0LtrE.mjs';
import { _ as _sfc_main$b } from './Input-aD0e3Jyr.mjs';
import { _ as _sfc_main$2$1, a as _sfc_main$c, b as _sfc_main$1$1 } from './TabsList-P1PqxA-H.mjs';
import { _ as _sfc_main$3$1, a as _sfc_main$2$2, c as _sfc_main$1$2, b as _sfc_main$e } from './CardDescription-BVNRvBA-.mjs';
...
import { _ as _sfc_main$5$1, a as _sfc_main$f, b as _sfc_main$2$3, c as _sfc_main$1$4, d as _sfc_main$4$1, e as _sfc_main$3$2 } from './TableHeader-Ia1Xb6zs.mjs';
  ...
  setup(__props) {
    ...
    const checkCdekRegister = async () => {
      try {
        ...
        registersSum.value = useMyFormatPrice(data.sum || 0) + "\u20BD";
      } catch (e) {
        console.log(e);
      }
    };
    ...
    const calcDeliveryInfo = (totals) => {
      deliveryInfo.value = [
        ...
        },
        {
          ...
          footer: totals.freeDeliveriesPrice
        }
        // {
        //   title: 'Платно',
        //   value: '0',
            ...
            _push2(ssrRenderComponent(_component_UiCardContent, { class: "p-4 space-y-3" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<!--]--><div class="flex justify-between gap-5 items-center"${_scopeId2}><span class="font-medium text-gray-800"${_scopeId2}>\u0420\u0435\u0435\u0441\u0442\u0440 \u0421\u0414\u0415\u041A</span><span class="${ssrRenderClass(["font-bold text-lg"])}"${_scopeId2}>${ssrInterpolate(unref(registersSum))}</span></div>`);
                } else {
                  return [
                    ...
                    createVNode("div", { class: "flex justify-between gap-5 items-center" }, [
                      ...
                      createVNode("span", { class: ["font-bold text-lg"] }, toDisplayString(unref(registersSum)), 1)
                    ])
                  ];
                }
              }),
...
//# sourceMappingURL=index-DXPVDTig.mjs.map
