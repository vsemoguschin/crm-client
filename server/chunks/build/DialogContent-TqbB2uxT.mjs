...
import { useForwardPropsEmits, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, DialogClose, useForwardProps, DialogTitle } from 'radix-vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emits = __emit;
    const delegatedProps = computed(() => {
      const { class: _, zIndex: __, ...delegated } = props;
      return delegated;
    });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(DialogOverlay), {
              ...
              style: { zIndex: (_a = props.zIndex) != null ? _a : 50 }
            ...
            _push2(ssrRenderComponent(unref(DialogContent), mergeProps(unref(forwarded), {
              ...
              style: { zIndex: (_b = props.zIndex) != null ? _b : 50 }
            }), {
            ...
            return [
              createVNode(unref(DialogOverlay), {
                class: "fixed inset-0 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
                style: { zIndex: (_c = props.zIndex) != null ? _c : 50 }
              }, null, 8, ["style"]),
              createVNode(unref(DialogContent), mergeProps(unref(forwarded), {
                ...
                style: { zIndex: (_d = props.zIndex) != null ? _d : 50 }
              }), {
                default: withCtx(() => [
                  renderSlot(_ctx.$slots, "default"),
                  createVNode(unref(DialogClose), { class: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-slate-100 data-[state=open]:text-slate-500 dark:ring-offset-slate-950 dark:focus:ring-slate-300 dark:data-[state=open]:bg-slate-800 dark:data-[state=open]:text-slate-400" }, {
...
export { _sfc_main$4 as _, _sfc_main$3 as a, _sfc_main as b, _sfc_main$2 as c, _sfc_main$1 as d };
//# sourceMappingURL=DialogContent-TqbB2uxT.mjs.map
