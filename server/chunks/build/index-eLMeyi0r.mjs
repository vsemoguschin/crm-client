...
import { _ as _sfc_main$d } from './ComboboxModels-C1xVEgP9.mjs';
import { _ as _sfc_main$e } from './Separator-CLaMwOnh.mjs';
import { _ as _sfc_main$8$1, u as useAttachments, e as _sfc_main$i } from './UserListItem-CLWLpvD9.mjs';
import { _ as _sfc_main$b } from './Switch-DpZI1Ncq.mjs';
import { _ as _sfc_main$8 } from './index-DXIlBIYA.mjs';
import { defineComponent, ref, computed, watch, unref, isRef, withCtx, createVNode, createBlock, createCommentVNode, openBlock, toDisplayString, Fragment, renderList, watchEffect, toValue, mergeModels, useModel, mergeProps, createTextVNode, nextTick, withModifiers, withKeys, useSSRContext } from 'vue';
...
import { _ as _sfc_main$2$2, a as _sfc_main$1$3, b as _sfc_main$9 } from './PopoverContent-tRGx4jX7.mjs';
import { _ as _sfc_main$a } from './Checkbox-MRDIcmc3.mjs';
import { _ as _sfc_main$4$1, b as _sfc_main$f, c as _sfc_main$2$3, d as _sfc_main$1$4 } from './DialogContent-TqbB2uxT.mjs';
import { _ as _sfc_main$g } from './DialogDescription-Bv3iXHRh.mjs';
import { _ as _sfc_main$h } from './Input-CzbisvbY.mjs';
import { useDebounceFn, useDocumentVisibility, useOnline, useIntervalFn } from '@vueuse/core';
import { _ as _sfc_main$c, u as useTaskApi } from './TaskModal-BFed0TGz.mjs';
      ...
      try {
        ...
        if (visibleMemberIds.value !== null) {
          visibleMemberIds.value = normalizeSelection(
            ((_b = visibleMemberIds.value) != null ? _b : []).filter((id) => id !== userId)
          );
        }
        syncSelection();
      } catch (e) {
        errorMsg.value = ((_d = (_c = e == null ? void 0 : e.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) || (e == null ? void 0 : e.message) || "\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F";
        await fetchMembers();
        syncSelection();
      } finally {
        isMutating.value = false;
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiDialogDescription = _sfc_main$g;
      const _component_UiInput = _sfc_main$h;
      const _component_UiScrollArea = _sfc_main$8$1;
      const _component_ClientOnly = __nuxt_component_14;
      const _component_MyUserListItem = _sfc_main$i;
  ...
  setup(__props) {
    ...
    async function fetchKanban(boardId) {
      ...
      try {
        ...
        boardWarnings.value = normalizeFilterList((_c = data == null ? void 0 : data.warnings) != null ? _c : data == null ? void 0 : data.warning);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UiButton, {
                    class: ["size-9 p-0 bg-neutral-800 hover:bg-neutral-700", unref(selectedFilters).length ? "text-indigo-200 bg-indigo-600/40 hover:bg-indigo-600/60" : ""],
            ...
            _push2(ssrRenderComponent(_component_UiPopoverContent, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center justify-between px-3 py-2 border-b border-neutral-600/60 text-sm"${_scopeId2}><span class="font-medium"${_scopeId2}>\u0424\u0438\u043B\u044C\u0442\u0440 \u043A\u0430\u0440\u0442\u043E\u0447\u0435\u043A</span><button type="button"${ssrIncludeBooleanAttr(!unref(selectedFilters).length) ? " disabled" : ""} class="${ssrRenderClass([!unref(selectedFilters).length ? "cursor-default opacity-60" : "", "text-xs text-neutral-400 hover:text-neutral-200"])}"${_scopeId2}> \u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C </button></div><div class="max-h-72 overflow-y-auto py-2"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("div", { class: "flex items-center justify-between px-3 py-2 border-b border-neutral-600/60 text-sm" }, [
                      ...
                      createVNode("button", {
                        type: "button",
                        class: ["text-xs text-neutral-400 hover:text-neutral-200", !unref(selectedFilters).length ? "cursor-default opacity-60" : ""],
...
//# sourceMappingURL=index-eLMeyi0r.mjs.map
