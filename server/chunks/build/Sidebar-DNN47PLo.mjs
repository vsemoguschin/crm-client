...
import { _ as _sfc_main$8, b as _sfc_main$7, c as _sfc_main$6, d as _sfc_main$5, e as _sfc_main$4$1, f as _sfc_main$9 } from './UserListItem-0VUPWG6P.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiDropdownMenu = _sfc_main$7;
      const _component_UiDropdownMenuTrigger = _sfc_main$6;
      const _component_UiDropdownMenuContent = _sfc_main$5;
      const _component_UiDropdownMenuItem = _sfc_main$4$1;
      const _component_MyUserListItem = _sfc_main$9;
                      ...
                      if (_push4) {
                        ...
                        ssrRenderList(filteredMenu.value, (item, i) => {
                          ...
                          if (item.name !== "\u0414\u043E\u0441\u043A\u0438") {
                            ...
                            _push4(`<div class="border-b border-neutral-600"${_scopeId3}><div class="px-4 py-3 text-base text-neutral-300"${_scopeId3}> \u0414\u043E\u0441\u043A\u0438 \u25BE </div><!--[-->`);
                            ssrRenderList(boards.value, (b) => {
                              _push4(ssrRenderComponent(_component_NuxtLink, {
                                key: b.id,
                                to: `/boards/${b.id}`,
                                class: "block px-6 py-2 text-sm hover:bg-neutral-500 bg-neutral-800",
                                onClick: ($event) => mobileOpen.value = false
                              }, {
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(filteredMenu.value, (item, i) => {
                              return openBlock(), createBlock(Fragment, { key: i }, [
                                item.name !== "\u0414\u043E\u0441\u043A\u0438" ? (openBlock(), createBlock(_component_NuxtLink, {
                                  ...
                                  createVNode("div", { class: "px-4 py-3 text-base text-neutral-300" }, " \u0414\u043E\u0441\u043A\u0438 \u25BE "),
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_UiDropdownMenuTrigger, { "as-child": "" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<button class="hover:text-bold hover:underline cursor-pointer"${_scopeId2}>\u0414\u043E\u0441\u043A\u0438 \u25BE</button>`);
                    } else {
                      return [
                        createVNode("button", { class: "hover:text-bold hover:underline cursor-pointer" }, "\u0414\u043E\u0441\u043A\u0438 \u25BE")
                      ];
                    }
                  }),
                  _: 2
...
//# sourceMappingURL=Sidebar-DNN47PLo.mjs.map
