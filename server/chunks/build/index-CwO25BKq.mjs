import { _ as _sfc_main$2 } from './Sidebar-Cft_0zX1.mjs';
import { _ as _sfc_main$2$1, a as _sfc_main$3, b as _sfc_main$1$1 } from './TabsList-BccwyRY_.mjs';
import { _ as _sfc_main$4 } from './TabsContent-B79lmJ9I.mjs';
import { _ as _sfc_main$4$2, a as _sfc_main$3$2, b as _sfc_main$9, c as _sfc_main$2$3, d as _sfc_main$1$3 } from './DialogContent-TqbB2uxT.mjs';
import { _ as _sfc_main$a } from './DialogDescription-Bv3iXHRh.mjs';
import { _ as _sfc_main$e } from './index-DXIlBIYA.mjs';
import { _ as _sfc_main$b } from './Label-C4ujgS20.mjs';
import { _ as _sfc_main$6$1, a as _sfc_main$4$3, b as _sfc_main$5$1, c as _sfc_main$3$3, d as _sfc_main$2$4 } from './SelectScrollDownButton-CHmlo_bA.mjs';
import { _ as _sfc_main$d } from './SelectGroup-C9qEX6zf.mjs';
import { _ as _sfc_main$c } from './Input-CzbisvbY.mjs';
...
import { _ as _sfc_main$8, e as _sfc_main$7 } from './UserListItem-CLWLpvD9.mjs';
import { _ as _sfc_main$5, a as _sfc_main$6, b as _sfc_main$2$2, c as _sfc_main$1$2, d as _sfc_main$4$1, e as _sfc_main$3$1 } from './TableHeader-CuJCJvE9.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const editedRoleIdStr = computed({
    ...
    const editUser = async () => {
      ...
      try {
        ...
        if (editedUser.value.tg_id !== null && !Number.isNaN(Number(editedUser.value.tg_id))) {
          payload.tg_id = Number(editedUser.value.tg_id);
        }
        ...
        for (const ws of workspaces.value) {
          for (const g of ws.groups) {
            ...
            if (idx !== -1) {
              ...
              if ("tg_id" in payload) user.tg_id = payload.tg_id;
        ...
        originalRoleId.value = (_a = editedUser.value.roleId) != null ? _a : null;
        ...
        uploadError.value = ((_c = (_b = e == null ? void 0 : e.response) == null ? void 0 : _b.data) == null ? void 0 : _c.message) || "\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0444\u043E\u0442\u043E";
      } finally {
    ...
    const openEdit = (user) => {
      ...
      editedUser.value.tg_id = typeof user.tg_id === "number" ? user.tg_id : (_b = user.tg) != null ? _b : null;
      editedUser.value.avatarUrl = (_d = (_c = user.avatarUrl) != null ? _c : user.avatar) != null ? _d : null;
      editedUser.value.roleId = (_f = (_e = user.role) == null ? void 0 : _e.id) != null ? _f : null;
      originalRoleId.value = (_g = editedUser.value.roleId) != null ? _g : null;
      avatarFile.value = null;
      if (avatarPreview.value) {
        URL.revokeObjectURL(avatarPreview.value);
        avatarPreview.value = null;
            ...
            _push2(ssrRenderComponent(_component_UiDialogContent, { class: "max-w-[420px] flex flex-col gap-4" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="flex gap-2"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UiSelect, {
                    modelValue: unref(editedRoleIdStr),
                    "onUpdate:modelValue": ($event) => isRef(editedRoleIdStr) ? editedRoleIdStr.value = $event : null
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UiSelectTrigger, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_UiSelectValue, { placeholder: "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0440\u043E\u043B\u044C" }, null, _parent5, _scopeId4));
                            } else {
                              return [
...
//# sourceMappingURL=index-CwO25BKq.mjs.map
