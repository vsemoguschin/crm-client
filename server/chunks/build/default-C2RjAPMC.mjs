import { defineComponent, ref, mergeProps, unref, withCtx, createTextVNode, toDisplayString, isVNode, createVNode, resolveDynamicComponent, createBlock, openBlock, createCommentVNode, Fragment, renderList, renderSlot, computed, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderVNode } from 'vue/server-renderer';
import { u as useIsLoadingStore, a as useAuthStore, c as cn } from './isLoading-D2o5w2su.mjs';
  ...
  setup(__props) {
    ...
    const getProfile = async () => {
      try {
        ...
        if (data.role.shortName === "MASTER") {
          await router.push("/production");
        }
        if (data.role.shortName === "PACKER") {
          await router.push("/production");
        }
      } catch (e) {
        isError.value = true;
    ...
    getProfile();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen" }, _attrs))}><section>`);
      if (isLoading.value) {
        _push(`<div>\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430</div>`);
      } else if (isError.value) {
        _push(`<div>\u041E\u0448\u0438\u0431\u043A\u0430</div>`);
      } else {
        _push(`<div>`);
...
//# sourceMappingURL=default-C2RjAPMC.mjs.map
