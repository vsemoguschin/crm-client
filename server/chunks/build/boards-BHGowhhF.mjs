...
import { b as _sfc_main$7, c as _sfc_main$6, d as _sfc_main$5, f as _sfc_main$4 } from './UserListItem-oJMTly4k.mjs';
import { _ as _sfc_main$8 } from './Input-RlyYgX4o.mjs';
import { _ as _sfc_main$9 } from './Textarea-hE0V8itU.mjs';
...
import { _ as _sfc_main$3$1 } from './ToastViewport-C3eNoi5T.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative h-screen hidden-scrollbar" }, _attrs))} data-v-6e64f2c4><div class="w-full fixed z-10" data-v-6e64f2c4>`);
      _push(ssrRenderComponent(_component_LayoutSidebar, null, null, _parent));
      _push(`</div><div class="min-h-screen bg-neutral-800 pt-14" data-v-6e64f2c4><div class="absolute top-[62px] left-4 flex items-center gap-3" data-v-6e64f2c4><div class="mt-[2px] flex items-center gap-1" data-v-6e64f2c4>`);
      _push(ssrRenderComponent(_component_UiButton, {
      ...
      if (unref(avaliableBoards).length) {
        ...
        _push(`<div class="text-neutral-400 text-sm" data-v-6e64f2c4>\u041D\u0435\u0442 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u044B\u0445 \u0434\u043E\u0441\u043E\u043A</div>`);
      }
      _push(`</div></div>`);
...
const boards = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6e64f2c4"]]);

export { boards as default };
//# sourceMappingURL=boards-BHGowhhF.mjs.map
