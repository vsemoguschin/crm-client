import { _ as _sfc_main$4, a as _sfc_main$3, b as _sfc_main$6, c as _sfc_main$2$1, d as _sfc_main$1$1 } from './DialogContent-Cpdz0S5M.mjs';
import { _ as _sfc_main$7 } from './DialogDescription-DYMwSQqW.mjs';
import { _ as _sfc_main$c } from './DialogFooter--i0s9obd.mjs';
import { _ as _sfc_main$5 } from './index-BASHn9g0.mjs';
import { _ as _sfc_main$8 } from './Label-DWRrr4Tu.mjs';
import { _ as _sfc_main$9 } from './Input-aD0e3Jyr.mjs';
import { _ as _sfc_main$a } from './Combobox-Y4naJjWu.mjs';
import { _ as _sfc_main$7$1, a as _sfc_main$5$1, b as _sfc_main$6$1, c as _sfc_main$4$1, d as _sfc_main$3$1, e as _sfc_main$2$2 } from './SelectScrollDownButton-B-CpaIEq.mjs';
import { _ as _sfc_main$b } from './Separator-D2Jy4Ik6.mjs';
import { defineComponent, h, ref, watch, withCtx, createTextVNode, createVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createCommentVNode, unref, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { a as useNuxtApp } from './server.mjs';
import { _ as _sfc_main$2$3, a as _sfc_main$1$2, b as _sfc_main$d } from './PopoverContent-DK_Eb2xq.mjs';
import { _ as _sfc_main$e } from './Checkbox-DpA8KJc_.mjs';
import { _ as _sfc_main$5$2, a as _sfc_main$f, b as _sfc_main$2$4, c as _sfc_main$1$3, d as _sfc_main$4$2, e as _sfc_main$3$2 } from './TableHeader-Ia1Xb6zs.mjs';
import { v as valueUpdater } from './isLoading-D2o5w2su.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiSelectGroup = _sfc_main$3$1;
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_MyCombobox, {
                    ...
                    class: newSuppliesData.value.supplier ? "" : "outline outline-1 outline-rose-300 rounded-md",
                  ...
                  _push3(`<div class="flex flex-col gap-5 grow"${_scopeId2}><!--[-->`);
                  ssrRenderList(newSuppliesData.value.positions, (position, index) => {
                    ...
                    _push3(ssrRenderComponent(_component_MyCombobox, {
                      ...
                      label: position.name,
                      class: [
                        position.name ? "" : "outline outline-1 outline-rose-300 rounded-md "
                      ],
                    ...
                    _push3(ssrRenderComponent(_component_UiInput, {
                      ...
                      placeholder: "\u041A\u043E\u043B-\u0432\u043E",
                      class: [
                        position.quantity > 0 ? "" : "outline outline-1 outline-rose-300",
                        "w-[100px]"
                      ]
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div class="relative"${_scopeId2}>`);
                    ...
                    _push3(ssrRenderComponent(_component_UiInput, {
                      ...
                      class: [
                        position.priceForItem > 0 ? "" : "outline outline-1 outline-rose-300",
                        "w-[100px]"
                      ]
                    }, null, _parent3, _scopeId2));
                    _push3(`</div><div class="relative w-full"${_scopeId2}>`);
                    ...
                    _push3(ssrRenderComponent(_component_UiSelect, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_UiSelectTrigger, {
                            class: position.category ? "" : "outline outline-1 outline-rose-300"
                          }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_UiSelectValue, {
                  ...
                  return [
                    ...
                    createVNode("div", { class: "flex gap-5" }, [
                      ...
                      createVNode("div", { class: "flex flex-col gap-5 grow" }, [
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiCheckbox = _sfc_main$e;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="flex flex-col gap-5 grow"><div class="flex flex-col gap-5"><!--[-->`);
      ssrRenderList(newSuppliesData.value.positions, (position, index) => {
        _push(`<div class="flex gap-2 items-center"><div class="relative w-full">`);
        _push(ssrRenderComponent(_component_UiLabel, { class: "font-medium text-slate-400 absolute left-2 top-[-13px] bg-white rounded-md p-1 whitespace-nowrap" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`\u041F\u043E\u0437\u0438\u0446\u0438\u044F`);
        ...
        _push(ssrRenderComponent(_component_UiSelect, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UiSelectTrigger, {
                class: position.category ? "" : "outline outline-1 outline-rose-300"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
      ...
      _push(`</div></div></div><div class="flex justify-between w-full gap-2">`);
      _push(ssrRenderComponent(_component_UiButton, {
        class: "",
        onClick: deleteItem
      }, {
...
const suppliesColumns = [
  ...
  // Колонка для даты отгрузки
  {
    ...
    cell: ({ row }) => h("div", { class: "text-center" }, row.getValue("shipmentDate") || "-")
  },
  ...
  // Колонка для позиций
  {
    ...
    header: ({ column }) => {
      return h(
        ...
        () => ["\u041F\u043E\u0437\u0438\u0446\u0438\u0438", h(ArrowUpDown, { class: "ml-2 h-4 w-4" })]
      );
    },
    cell: ({ row }) => {
      ...
      return h(
        "div",
        { class: "text-center" },
        `${positions.length} \u043F\u043E\u0437. (${useMyFormatPrice(+totalPrice.toFixed(2))}\u20BD)`
      );
    },
  ...
  // Колонка для номера счета
  {
    ...
    cell: ({ row }) => h("div", { class: "text-center" }, row.getValue("invoice") || "-")
  },
...
export { _sfc_main$2 as _, _sfc_main$1 as a, _sfc_main as b, suppliesColumns as s };
//# sourceMappingURL=table.columns-B8kSIx8-.mjs.map
