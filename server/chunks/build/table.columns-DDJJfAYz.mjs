...
import { _ as _sfc_main$d } from './DialogFooter-C_pMBt3g.mjs';
...
import { _ as _sfc_main$c } from './ScrollArea-CPCatQNH.mjs';
...
import { _ as _sfc_main$2$3, a as _sfc_main$1$2, b as _sfc_main$e } from './PopoverContent-Bm4609Rb.mjs';
import { _ as _sfc_main$f } from './Checkbox-Cx8b_7FZ.mjs';
import { _ as _sfc_main$5$2, a as _sfc_main$g, b as _sfc_main$2$4, c as _sfc_main$1$3, d as _sfc_main$4$2, e as _sfc_main$3$2 } from './TableHeader-e42BjEs_.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(newSuppliesData.value.positions, (position, index) => {
              ...
              _push2(`</div><div class="relative w-full"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UiLabel, { class: "font-medium text-slate-400 absolute left-2 top-[-13px] bg-white rounded-md p-1 whitespace-nowrap" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F`);
...
const suppliesColumns = [
  ...
  // Колонка для даты отгрузки
  {
    ...
    cell: ({ row }) => {
      ...
      const formateDate = new Date(date).toLocaleDateString();
      console.log(formateDate === "Invalid Date");
      return h(
        "div",
        { class: "text-center" },
        formateDate === "Invalid Date" ? "-" : formateDate
  ...
  // Колонка для позиций
  {
    ...
    cell: ({ row }) => {
      ...
      return h(
        "div",
        { class: "text-center" },
        `${positions.length} \u043F\u043E\u0437. (${useMyFormatPrice(
...
//# sourceMappingURL=table.columns-DDJJfAYz.mjs.map
