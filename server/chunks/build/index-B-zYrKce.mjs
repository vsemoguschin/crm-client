...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const incomeAllDealsPrice = calculateIncomeWithPercent(
      props.plData.income.allDealsPrice
    );
    const incomeSendDeals = calculateIncomeWithPercent(
      props.plData.income.sendDeals
    );
    const incomeRevenue = calculateIncomeWithPercent(props.plData.income.revenue);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UiTableBody, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(_ctx.plData.expenses.production.supplies.data, (item, idx) => {
                  ...
                  _push3(ssrRenderComponent(_component_UiTableRow, { class: "text-center bg-slate-300 hover:bg-slate-300" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<!--[-->`);
                        ssrRenderList(_ctx.plData.expenses.production.supplies.totals, (total, idx2) => {
                        ...
                        return [
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(_ctx.plData.expenses.production.supplies.totals, (total, idx2) => {
                  ...
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(_ctx.plData.expenses.production.supplies.data, (item, idx) => {
  ...
  setup(__props) {
    ...
    const calculateIncomeWithPercent = (data, field) => computed(
      () => data.map((item, index) => {
        ...
        return {
          value: item[field],
          changePercent: !((_a2 = data[index - 1]) == null ? void 0 : _a2[field]) || data[index - 1][field] === 0 ? 0 : +((item[field] - data[index - 1][field]) / data[index - 1][field] * 100).toFixed(2)
        };
      })
    );
    const calculatePercentOfIncome = (data, getValue) => computed(
      () => props.plData.periods.map((period) => {
        ...
        const incomeValue = (_b2 = (_a2 = props.plData.income.find((item) => item.period === period)) == null ? void 0 : _a2.allDealsPrice) != null ? _b2 : 0;
    ...
    const totalExpensesShare = computed(
      () => props.plData.periods.map((period, index) => {
        ...
        const incomeValue = (_t = (_s = props.plData.income.find((item) => item.period === period)) == null ? void 0 : _s.allDealsPrice) != null ? _t : 0;
    ...
    const fetchPLData = async () => {
      ...
      try {
        if (project.value === "book") {
          ...
          const response = await $useApi.get("/pnl", {
            params: {
              period: period.value,
...
//# sourceMappingURL=index-B-zYrKce.mjs.map
