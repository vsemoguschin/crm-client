import { defineComponent, computed, ref, unref, mergeProps, withCtx, renderSlot, createVNode, createBlock, openBlock, createCommentVNode, toDisplayString, reactive, useSSRContext } from 'vue';
...
function useAttachments() {
  ...
  function buildPreviewProxySrc(path, bust) {
    const q = { path, w: THUMB_W, h: THUMB_H, format: THUMB_FMT, v: bust };
  ...
  function getPreviewSrc(rawPath) {
    ...
    {
      if (!previewCache[key]) {
        previewCache[key] = buildPreviewProxySrc(path);
      }
  ...
  async function refreshPreview(rawPath) {
    ...
    if (!path) return;
    {
      previewCache[path] = buildPreviewProxySrc(path, Date.now());
      return;
    }
  }
...
export { _sfc_main$4 as _, _sfc_main$5 as a, _sfc_main as b, _sfc_main$3 as c, _sfc_main$1 as d, _sfc_main$2 as e, useAttachments as u };
//# sourceMappingURL=UserListItem-CgSSeERn.mjs.map
