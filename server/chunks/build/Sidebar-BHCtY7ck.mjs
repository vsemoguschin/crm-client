...
import { _ as _sfc_main$4$1, b as _sfc_main$3$1, c as _sfc_main$2$2, d as _sfc_main$1$2, e as _sfc_main$5 } from './DropdownMenuItem-lhpWPi-N.mjs';
...
const MENU_DATA = [
  ...
  },
  {
    ...
    name: "\u0414\u043E\u0441\u043A\u0438",
    url: "/boards",
    allowedRoles: ["ADMIN", "G", "KD", "DO", "ROD", "MOP", "DIZ", "DP"]
  },
  // {
  //   icon: '',
  //   name: 'Зарплаты',
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiDropdownMenuItem = _sfc_main$5;
      const _component_UiDropdownMenuLabel = _sfc_main$1;
      const _component_UiDropdownMenuSeparator = _sfc_main$2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex bg-white" }, _attrs))}><header class="font-medium text-black/70 w-full z-10 sticky top-0 h-14 flex items-center justify-start gap-3 border-b bg-background px-4 min-[900px]:px-6"><div><div class="flex items-center gap-3">`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UiSheetContent, {
              side: "left",
              class: "w-[88%] max-w-sm p-0"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="px-4 py-3 border-b"${_scopeId2}><div class="text-sm text-neutral-500"${_scopeId2}>\u041C\u0435\u043D\u044E</div><div class="text-base font-semibold text-neutral-900"${_scopeId2}>${ssrInterpolate(userName.value)}</div></div>`);
                        ...
                        ssrRenderList(filteredMenu.value, (item, i) => {
                          ...
                          if (item.name !== "\u0414\u043E\u0441\u043A\u0438") {
                            _push4(ssrRenderComponent(_component_NuxtLink, {
                              to: item.url,
                              class: [
                                "px-4 py-3 text-base border-b hover:bg-neutral-50",
                                isActive(item.url) ? "text-black font-semibold" : "text-neutral-700"
                              ],
                            ...
                            _push4(`<div class="border-b"${_scopeId3}><div class="px-4 py-3 text-base text-neutral-700"${_scopeId3}> \u0414\u043E\u0441\u043A\u0438 \u25BE </div><!--[-->`);
                            ssrRenderList(boards.value, (b) => {
                              _push4(ssrRenderComponent(_component_NuxtLink, {
                                key: b.id,
                                to: `/boards/${b.id}`,
                                class: "block px-6 py-2 text-sm hover:bg-neutral-100 bg-neutral-50",
                                onClick: ($event) => mobileOpen.value = false
                              }, {
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(`${ssrInterpolate(b.title || b.title)}`);
                                  } else {
                                    return [
                                      createTextVNode(toDisplayString(b.title || b.title), 1)
                                    ];
                                  }
                                }),
                                _: 2
                          ...
                          createVNode("nav", { class: "flex flex-col" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(filteredMenu.value, (item, i) => {
                              return openBlock(), createBlock(Fragment, { key: i }, [
                                item.name !== "\u0414\u043E\u0441\u043A\u0438" ? (openBlock(), createBlock(_component_NuxtLink, {
                                  key: 0,
                                  to: item.url,
                                  class: [
                                    "px-4 py-3 text-base border-b hover:bg-neutral-50",
                                  ...
                                  _: 2
                                }, 1032, ["to", "class", "onClick"])) : (openBlock(), createBlock("div", {
                                  key: 1,
                                  class: "border-b"
                                }, [
                                  createVNode("div", { class: "px-4 py-3 text-base text-neutral-700" }, " \u0414\u043E\u0441\u043A\u0438 \u25BE "),
                                  (openBlock(true), createBlock(Fragment, null, renderList(boards.value, (b) => {
                  ...
                  return [
                    createVNode("div", { class: "px-4 py-3 border-b" }, [
                      createVNode("div", { class: "text-sm text-neutral-500" }, "\u041C\u0435\u043D\u044E"),
                      createVNode("div", { class: "text-base font-semibold text-neutral-900" }, toDisplayString(userName.value), 1)
                    ]),
      ...
      ssrRenderList(filteredMenu.value, (item, i) => {
        ...
        if (item.name !== "\u0414\u043E\u0441\u043A\u0438") {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: item.url,
            class: ["hover:text-black", isActive(item.url) ? "text-black font-semibold" : ""]
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_UiDropdownMenuTrigger, { "as-child": "" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<button class="hover:text-black cursor-pointer"${_scopeId2}>\u0414\u043E\u0441\u043A\u0438 \u25BE</button>`);
                    } else {
                      return [
                        createVNode("button", { class: "hover:text-black cursor-pointer" }, "\u0414\u043E\u0441\u043A\u0438 \u25BE")
                      ];
                    }
                  }),
                  _: 2
      ...
      _push(`<!--]--></nav></div><div class="ml-auto">`);
      _push(ssrRenderComponent(_component_UiDropdownMenu, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UiDropdownMenuTrigger, { "as-child": "" }, {
...
//# sourceMappingURL=Sidebar-BHCtY7ck.mjs.map
