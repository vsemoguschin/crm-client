import { _ as _sfc_main$g } from './Sidebar-D29xHklW.mjs';
import { _ as _sfc_main$2$1, a as _sfc_main$h, b as _sfc_main$1$1 } from './TabsList-DbIwKgY4.mjs';
import { _ as _sfc_main$i } from './Input-DBSZ1Mdv.mjs';
import { _ as _sfc_main$j } from './ScrollArea-CPCatQNH.mjs';
import { _ as _sfc_main$5$1, a as _sfc_main$k, b as _sfc_main$2$2, c as _sfc_main$1$2, d as _sfc_main$4$1, e as _sfc_main$3$1 } from './TableHeader-pVk7uQ16.mjs';
import { f as _sfc_main$6$1, _ as _sfc_main$5$2, a as _sfc_main$4$4, b as _sfc_main$3$4, c as _sfc_main$2$5, d as _sfc_main$1$6, e as _sfc_main$t } from './index-DnaTyMzW.mjs';
import { _ as _sfc_main$4$3, a as _sfc_main$3$3, b as _sfc_main$p, c as _sfc_main$2$4, d as _sfc_main$1$5 } from './DialogContent-N24W_Bx3.mjs';
import { _ as _sfc_main$q } from './DialogDescription-CHHvh8Oz.mjs';
import { _ as _sfc_main$s } from './DialogFooter-C_pMBt3g.mjs';
import { _ as _sfc_main$u } from './Label-B6Kf4x8e.mjs';
import { _ as _sfc_main$7$1, a as _sfc_main$5$3, b as _sfc_main$6$2, c as _sfc_main$4$5, d as _sfc_main$3$5, e as _sfc_main$2$6 } from './SelectScrollDownButton-BvZ6jJsS.mjs';
import { _ as _sfc_main$v } from './Textarea-UC8L-TqN.mjs';
import { a as useAuthStore, _ as _sfc_main$w } from './isLoading-BbWzubgi.mjs';
import { defineComponent, ref, watch, mergeProps, unref, isRef, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createVNode, withModifiers, createCommentVNode, computed, useSSRContext } from 'vue';
...
import { _ as _sfc_main$x } from './Switch-DrDfxfly.mjs';
import { Q as Qn } from './main-BplioMC0.mjs';
import { ExternalLink, MessageCircle } from 'lucide-vue-next';
import { _ as _sfc_main$l } from './ComboboxModels-BJ2QnOFE.mjs';
import { _ as _sfc_main$y } from './TabsContent-CO2mHCzx.mjs';
import { _ as _sfc_main$3$2, a as _sfc_main$2$3, b as _sfc_main$m, c as _sfc_main$1$3 } from './CardDescription-Bo1EqluP.mjs';
import { _ as _sfc_main$n } from './CardContent-BEDjQwzu.mjs';
import { _ as _sfc_main$o } from './Separator-kiHjH00C.mjs';
import { _ as _sfc_main$4$2, a as _sfc_main$1$4, s as suppliesColumns, b as _sfc_main$r } from './table.columns-CY-1_-4J.mjs';
...
import './CommandInput-DGCCooe7.mjs';
import './Combobox-Bi_-LRsn.mjs';
import './index-CQUfSr7s.mjs';
import './CommandSeparator-BW0ck4T9.mjs';
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const calculateCost = () => {
      ...
      let cost = 0;
      if (((_a = props.curUser) == null ? void 0 : _a.workSpaceId) === 8) {
        switch (type) {
          case "\u0421\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u043D\u0430\u044F":
          case "\u0412\u0411":
          case "\u041E\u0417\u041E\u041D":
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiLabel = _sfc_main$u;
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const calculateCost = () => {
      ...
      let cost = 0;
      console.log((_a = props.curUser) == null ? void 0 : _a.workSpaceId);
      if (((_b = props.curUser) == null ? void 0 : _b.workSpaceId) === 8) {
        cost = items * 100 + adapters * 60 + lam * 20 + dimmers * 60 + (overSize ? 200 : 0) + (isGift ? 120 : 0) + dops;
      } else {
        cost = items * 100 + adapters * 60 + lam * 20 + dimmers * 60 + (overSize ? 100 : 0) + (isGift ? 120 : 0) + dops;
      }
      editedReport.value.cost = cost;
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiLabel = _sfc_main$u;
      const _component_UiInput = _sfc_main$i;
      const _component_UiSwitch = _sfc_main$x;
      const _component_UiTextarea = _sfc_main$v;
      const _component_UiDialogFooter = _sfc_main$s;
      const _component_UiButton = _sfc_main$w;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isEditMasterReportModalOpen = ref(false);
    const editingMasterReport = ref(null);
    ...
    const editReport = (report) => {
      curEmployee.value = report.userId;
      console.log(report.report_type);
      if (report.report_type === "\u0421\u0431\u043E\u0440\u043A\u0430") {
        editingMasterReport.value = { ...report };
        isEditMasterReportModalOpen.value = true;
      } else if (report.report_type === "\u0414\u0440\u0443\u0433\u043E\u0435") {
        editingOtherReport.value = { ...report };
        isEditOtherModalOpen.value = true;
      } else if (report.report_type === "\u0423\u043F\u0430\u043A\u043E\u0432\u043A\u0430") {
        editingPakerReport.value = { ...report };
        isEditPackerReportModalOpen.value = true;
      } else if (report.report_type === "\u0420\u0435\u043C\u043E\u043D\u0442") {
        editingRepairReport.value = { ...report };
        isEditRepairModalOpen.value = true;
      }
    };
    const formatRange = (date) => {
      return "\u041F\u0435\u0440\u0438\u043E\u0434 \u0441 " + date.map((d) => {
    ...
    const handleReportUpdated = async () => {
      await getOrders();
      isEditMasterReportModalOpen.value = false;
      editingMasterReport.value = null;
      ...
      isEditPackerReportModalOpen.value = false;
      _sfc_main$c.value = null;
    };
    watch(range, () => {
      console.log("range");
      getOrders();
    ...
    watch(search, async () => {
      if (search.value.length > 2) {
        try {
          const { data } = await $useApi.get("/production/reports/search", {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiInput = _sfc_main$i;
      const _component_UiScrollArea = _sfc_main$j;
      const _component_UiTable = _sfc_main$5$1;
      const _component_UiTableCaption = _sfc_main$6$1;
      const _component_UiTableHeader = _sfc_main$k;
      ...
      const _component_MyProductionEditMasterReport = _sfc_main$f;
      const _component_MyProductionEditMasterRepairReport = _sfc_main$e;
      const _component_MyProductionEditOtherReport = _sfc_main$d;
      const _component_MyProductionEditPackerReport = _sfc_main$c;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-2" }, _attrs))}><div class="flex flex-col gap-2"><div class="flex items-center"><div class="w-full flex items-center gap-2"><div class="w-[215px]">`);
      _push(ssrRenderComponent(_component_UiInput, {
        modelValue: search.value,
        "onUpdate:modelValue": ($event) => search.value = $event,
        placeholder: "\u0413\u043B\u043E\u0431\u0430\u043B\u044C\u043D\u044B\u0439 \u043F\u043E\u0438\u0441\u043A..."
      }, null, _parent));
      _push(`</div><div class="w-[330px]">`);
      ...
      if (isLoading.value) {
        ...
        _push(`<div>`);
        _push(ssrRenderComponent(_component_UiScrollArea, { class: "h-[calc(100vh-175px)] w-[550px] rounded-sm" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UiTable, { class: "bg-white text-sm relative" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_UiTableCaption, null, null, _parent3, _scopeId2));
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_UiTableRow, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_UiTableHead, { class: "text-center font-semibold text-gray-700" }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`\u0414\u0430\u0442\u0430`);
                                    } else {
                                ...
                                return [
                                  createVNode(_component_UiTableHead, { class: "text-center font-semibold text-gray-700" }, {
                                    default: withCtx(() => [
                                      createTextVNode("\u0414\u0430\u0442\u0430")
                                    ]),
                                    _: 1
                    ...
                    _push3(`<!--[-->`);
                    ssrRenderList(orders.value, (order, i) => {
                      _push3(ssrRenderComponent(_component_UiTableBody, {
                        key: i,
                        class: "border-1 border-b-black"
                      }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(_component_UiTableRow, { class: "relative bg-slate-300 hover:bg-slate-300 font-semibold" }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(ssrRenderComponent(_component_UiTableCell, {
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<div class="w-full py-2.5 pl-4"${_scopeId5}>`);
                                        if (order.name.startsWith("http")) {
                                          _push6(`<a${ssrRenderAttr("href", order.name)} target="_blank" class="text-blue-600 hover:underline flex items-center"${_scopeId5}><span${_scopeId5}> \u041A\u0430\u0440\u0442\u043E\u0447\u043A\u0430 </span>`);
                                          _push6(ssrRenderComponent(unref(ExternalLink), { class: "h-4" }, null, _parent6, _scopeId5));
                                          _push6(`</a>`);
                                        } else {
                                          _push6(`<div${_scopeId5}><span${_scopeId5}>${ssrInterpolate(order.name)}</span></div>`);
                                        }
                                        _push6(`</div>`);
                                      } else {
                                        return [
                                          createVNode("div", { class: "w-full py-2.5 pl-4" }, [
                                            order.name.startsWith("http") ? (openBlock(), createBlock("a", {
                                              key: 0,
                                              href: order.name,
                                              target: "_blank",
                                              ...
                                              createVNode("span", null, " \u041A\u0430\u0440\u0442\u043E\u0447\u043A\u0430 "),
                                              createVNode(unref(ExternalLink), { class: "h-4" })
                                            ], 8, ["href", "onClick"])) : (openBlock(), createBlock("div", { key: 1 }, [
                                              createVNode("span", null, toDisplayString(order.name), 1)
                                            ]))
                                          ])
                                        ];
                                      }
                                  ...
                                  _push5(ssrRenderComponent(_component_UiTableCell, {
                                    colspan: "1",
                                    class: "text-right text-green-600 pr-4"
                                  }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`${ssrInterpolate(orders.value[i].orders.reduce((a, b) => a + b.cost, 0) - orders.value[i].orders.reduce((a, b) => a + b.penaltyCost, 0) + "\u20BD")}`);
                                      } else {
                                        return [
                                          createTextVNode(toDisplayString(orders.value[i].orders.reduce((a, b) => a + b.cost, 0) - orders.value[i].orders.reduce((a, b) => a + b.penaltyCost, 0) + "\u20BD"), 1)
                                        ];
                                      }
                                    }),
                                    _: 2
                            ...
                            _push4(`<!--[-->`);
                            ssrRenderList(order.orders, (rep, indx) => {
                              _push4(ssrRenderComponent(_component_UiTableRow, {
                                key: indx,
                                class: {
                                  "text-center bg-gray-50 cursor-pointer hover:bg-slate-200": true,
                                  "bg-red-100": rep.penaltyCost,
                                  "bg-blue-100/50": rep.report_type === "\u0420\u0435\u043C\u043E\u043D\u0442",
                                  "bg-yellow-100/50": rep.report_type === "\u0414\u0440\u0443\u0433\u043E\u0435"
                                },
                                onClick: ($event) => editReport(rep)
                              }, {
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(ssrRenderComponent(_component_UiTableCell, { class: "text-xs text-gray-600 py-1.5" }, {
                                      default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          _push6(`<div class="flex items-center gap-2"${_scopeId5}><span${_scopeId5}>${ssrInterpolate(new Date(rep.date).toLocaleDateString())}</span>`);
                                          if (rep.comment) {
                                          ...
                                          return [
                                            createVNode("div", { class: "flex items-center gap-2" }, [
                                              createVNode("span", null, toDisplayString(new Date(rep.date).toLocaleDateString()), 1),
                                              rep.comment ? (openBlock(), createBlock(unref(MessageCircle), { key: 0 })) : createCommentVNode("", true)
                                            ])
                                          ];
                                        }
                                      }),
                                    ...
                                    _push5(ssrRenderComponent(_component_UiTableCell, { class: "py-1.5 flex flex-col" }, {
                                      default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          _push6(`<span${_scopeId5}>${ssrInterpolate(rep.penaltyCost ? "\u0428\u0442\u0440\u0430\u0444" : rep.report_type)}</span>`);
                                          if (rep.type) {
                                            _push6(`<span class="text-xs text-gray-500"${_scopeId5}>${ssrInterpolate(rep.type)}</span>`);
                                          } else {
                                            _push6(`<!---->`);
                                          }
                                          if (rep.dopsComment) {
                                            _push6(`<span class="text-wrap text-gray-600"${_scopeId5}> + ${ssrInterpolate(rep.dopsComment)}</span>`);
                                          } else {
                                            _push6(`<!---->`);
                                          }
                                        } else {
                                          return [
                                            createVNode("span", null, toDisplayString(rep.penaltyCost ? "\u0428\u0442\u0440\u0430\u0444" : rep.report_type), 1),
                                            rep.type ? (openBlock(), createBlock("span", {
                                              key: 0,
                                              class: "text-xs text-gray-500"
                                            }, toDisplayString(rep.type), 1)) : createCommentVNode("", true),
                                            rep.dopsComment ? (openBlock(), createBlock("span", {
                                              key: 1,
                                              class: "text-wrap text-gray-600"
                                            }, " + " + toDisplayString(rep.dopsComment), 1)) : createCommentVNode("", true)
                                          ];
                                        }
                                      }),
                                      _: 2
                                    }, _parent5, _scopeId4));
                                    _push5(ssrRenderComponent(_component_UiTableCell, { class: "py-1.5" }, {
                                      default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                        var _a2, _b2;
                                        var _a, _b;
                                        if (_push6) {
                                          _push6(`<span${_scopeId5}>${ssrInterpolate((_a2 = (_a = rep.user) == null ? void 0 : _a.fullName) != null ? _a2 : "\u041D\u0435\u0442 \u0438\u043C\u0435\u043D\u0438")}</span>`);
                                          if (rep.report_type === "\u0421\u0431\u043E\u0440\u043A\u0430" && rep.metrs || rep.els) {
                                            _push6(`<div class="flex text-xs text-gray-600 justify-center"${_scopeId5}><span${_scopeId5}>${ssrInterpolate(rep.metrs)}\u043C./ </span><span${_scopeId5}>${ssrInterpolate(rep.els)}\u044D\u043B. </span></div>`);
                                          } else {
                                            _push6(`<!---->`);
                                          }
                                        } else {
                                          return [
                                            createVNode("span", null, toDisplayString((_b2 = (_b = rep.user) == null ? void 0 : _b.fullName) != null ? _b2 : "\u041D\u0435\u0442 \u0438\u043C\u0435\u043D\u0438"), 1),
                                            rep.report_type === "\u0421\u0431\u043E\u0440\u043A\u0430" && rep.metrs || rep.els ? (openBlock(), createBlock("div", {
                                              key: 0,
                                              class: "flex text-xs text-gray-600 justify-center"
                                            }, [
                                              createVNode("span", null, toDisplayString(rep.metrs) + "\u043C./ ", 1),
                                              createVNode("span", null, toDisplayString(rep.els) + "\u044D\u043B. ", 1)
                                            ])) : createCommentVNode("", true)
                                          ];
                                        }
                                      }),
                                    ...
                                    _push5(ssrRenderComponent(_component_UiTableCell, { class: "py-1.5 flex flex-col" }, {
                                      default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          if (rep.cost) {
                                            _push6(`<span class="text-green-600"${_scopeId5}>+${ssrInterpolate(rep.cost)}\u20BD</span>`);
                                          } else {
                                            _push6(`<!---->`);
                                          }
                                          if (rep.penaltyCost) {
                                            _push6(`<span class="text-sx text-red-500"${_scopeId5}>-${ssrInterpolate(rep.penaltyCost)}\u20BD</span>`);
                                          } else {
                                            _push6(`<!---->`);
                                          }
                                        } else {
                                          return [
                                            rep.cost ? (openBlock(), createBlock("span", {
                                              key: 0,
                                              class: "text-green-600"
                                            }, "+" + toDisplayString(rep.cost) + "\u20BD", 1)) : createCommentVNode("", true),
                                            rep.penaltyCost ? (openBlock(), createBlock("span", {
                                              key: 1,
                                              class: "text-sx text-red-500"
                                            }, "-" + toDisplayString(rep.penaltyCost) + "\u20BD", 1)) : createCommentVNode("", true)
                                          ];
                                        }
                                      }),
                                      _: 2
                                    ...
                                    return [
                                      createVNode(_component_UiTableCell, { class: "text-xs text-gray-600 py-1.5" }, {
                                        default: withCtx(() => [
                                          createVNode("div", { class: "flex items-center gap-2" }, [
                                            createVNode("span", null, toDisplayString(new Date(rep.date).toLocaleDateString()), 1),
                                            rep.comment ? (openBlock(), createBlock(unref(MessageCircle), { key: 0 })) : createCommentVNode("", true)
                                      ...
                                      createVNode(_component_UiTableCell, { class: "py-1.5 flex flex-col" }, {
                                        default: withCtx(() => [
                                          createVNode("span", null, toDisplayString(rep.penaltyCost ? "\u0428\u0442\u0440\u0430\u0444" : rep.report_type), 1),
                                          rep.type ? (openBlock(), createBlock("span", {
                                            key: 0,
                                      ...
                                      createVNode(_component_UiTableCell, { class: "py-1.5" }, {
                                        default: withCtx(() => {
                                          var _a2;
                                          var _a;
                                          return [
                                            createVNode("span", null, toDisplayString((_a2 = (_a = rep.user) == null ? void 0 : _a.fullName) != null ? _a2 : "\u041D\u0435\u0442 \u0438\u043C\u0435\u043D\u0438"), 1),
                                            rep.report_type === "\u0421\u0431\u043E\u0440\u043A\u0430" && rep.metrs || rep.els ? (openBlock(), createBlock("div", {
                                              key: 0,
                                              class: "flex text-xs text-gray-600 justify-center"
                                            }, [
                            ...
                            return [
                              createVNode(_component_UiTableRow, { class: "relative bg-slate-300 hover:bg-slate-300 font-semibold" }, {
                                default: withCtx(() => [
                                  createVNode(_component_UiTableCell, {
                                    colspan: "3",
                                    class: "p-0"
                              ...
                              (openBlock(true), createBlock(Fragment, null, renderList(order.orders, (rep, indx) => {
                    ...
                    return [
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(orders.value, (order, i) => {
                        return openBlock(), createBlock(_component_UiTableBody, {
                          key: i,
                          class: "border-1 border-b-black"
                        }, {
                          default: withCtx(() => [
              ...
              return [
                createVNode(_component_UiTable, { class: "bg-white text-sm relative" }, {
                  default: withCtx(() => [
                    createVNode(_component_UiTableCaption),
                    createVNode(_component_UiTableHeader, { class: "bg-gray-50 sticky top-0 z-50" }, {
                      default: withCtx(() => [
      ...
      if (isEditMasterReportModalOpen.value && editingMasterReport.value) {
        _push(ssrRenderComponent(_component_MyProductionEditMasterReport, {
          report: editingMasterReport.value,
          "cur-user": unref(curUser),
          onReportUpdated: handleReportUpdated,
          onClose: ($event) => isEditMasterReportModalOpen.value = false
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      ...
      if (isEditPackerReportModalOpen.value && editingPakerReport.value) {
        _push(ssrRenderComponent(_component_MyProductionEditPackerReport, {
          report: editingPakerReport.value,
          "cur-user": unref(curUser),
          onReportUpdated: handleReportUpdated,
          onClose: ($event) => isEditPackerReportModalOpen.value = false
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/my/production/orders/List.vue");
  ...
  setup(__props, { emit: __emit }) {
    ...
    watch(
      ...
      () => {
        ...
        if (props.curUser.role.shortName === "MASTER") {
          disabled.value = !(date && name && metrs > 0 && els > 0 && type);
        } else {
          disabled.value = !(date && name && type);
        }
      },
      { deep: true }
    );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiTabsList = _sfc_main$h;
      const _component_UiTabsTrigger = _sfc_main$1$1;
      const _component_UiTabsContent = _sfc_main$y;
      const _component_UiLabel = _sfc_main$u;
      const _component_UiInput = _sfc_main$i;
      const _component_UiSelect = _sfc_main$7$1;
      const _component_UiSelectTrigger = _sfc_main$5$3;
                        ...
                        _push4(ssrRenderComponent(_component_UiTabsContent, { value: "new" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`</div></div></div>`);
                              if (_ctx.curUser.role.shortName !== "MASTER") {
                                _push5(`<div class="flex flex-col gap-2"${_scopeId4}><div class="relative"${_scopeId4}>`);
                                _push5(ssrRenderComponent(_component_UiLabel, { class: "font-medium text-slate-400 absolute left-2 top-[-13px] bg-white rounded-md p-1" }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`\u0428\u0442\u0440\u0430\u0444`);
                              ...
                              _push5(`<span${_scopeId4}> \u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C: ${ssrInterpolate(newReportMaster.value.cost)}\u0440. </span></div><div class="flex justify-end w-full"${_scopeId4}>`);
                              ...
                              return [
                                createVNode("div", { class: "flex flex-col gap-5" }, [
                                  ...
                                  _ctx.curUser.role.shortName !== "MASTER" ? (openBlock(), createBlock("div", {
                                    key: 0,
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      var _a, _b, _c;
      const _component_MyComboboxModels = _sfc_main$l;
      const _component_UiTabs = _sfc_main$2$1;
      const _component_UiTabsList = _sfc_main$h;
      const _component_UiTabsTrigger = _sfc_main$1$1;
      const _component_UiScrollArea = _sfc_main$j;
      ...
      const _component_UiTableBody = _sfc_main$4$1;
      const _component_UiTableCell = _sfc_main$3$1;
      const _component_MyProductionCreateMasterReport = _sfc_main$a;
      const _component_MyProductionEditMasterReport = _sfc_main$f;
      const _component_MyProductionEditMasterRepairReport = _sfc_main$e;
      const _component_MyProductionEditOtherReport = _sfc_main$d;
      ...
      if (((_b = unref(curUser)) == null ? void 0 : _b.role.shortName) !== "MASTER") {
      ...
      if (isLoading.value) {
        ...
        _push(`<div>`);
        _push(ssrRenderComponent(_component_UiScrollArea, { class: "h-[calc(100vh-325px)] rounded-sm" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UiTable, { class: "bg-white rounded-sm relative" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_UiTableCaption, null, null, _parent3, _scopeId2));
                    _push3(ssrRenderComponent(_component_UiTableHeader, { class: "sticky top-0 z-50 bg-gray-50" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_UiTableRow, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        ...
                                        if (report.name.startsWith("http")) {
                                          ...
                                          _push6(`<div class="flex flex-col items-center"${_scopeId5}><span${_scopeId5}>${ssrInterpolate(report.name)}</span></div>`);
                                        }
                                        _push6(`<span class="text-wrap text-gray-600"${_scopeId5}>(${ssrInterpolate(report.type)})</span></div>`);
                                      } else {
                                        return [
                                  ...
                                  _push5(ssrRenderComponent(_component_UiTableCell, { class: "text-center" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<div class="flex flex-col items-center"${_scopeId5}><span class="font-semibold text-green-600"${_scopeId5}>+${ssrInterpolate(report.cost)}\u0440.</span>`);
                    ...
                    return [
                      createVNode(_component_UiTableCaption),
                      createVNode(_component_UiTableHeader, { class: "sticky top-0 z-50 bg-gray-50" }, {
                        default: withCtx(() => [
                          createVNode(_component_UiTableRow, null, {
                            default: withCtx(() => [
                              createVNode(_component_UiTableHead, null, {
              ...
              return [
                createVNode(_component_UiTable, { class: "bg-white rounded-sm relative" }, {
                  default: withCtx(() => [
                    createVNode(_component_UiTableCaption),
                    createVNode(_component_UiTableHeader, { class: "sticky top-0 z-50 bg-gray-50" }, {
                      default: withCtx(() => [
      ...
      if (unref(curUser)) {
        _push(ssrRenderComponent(_component_MyProductionCreateMasterReport, {
          "master-id": (_a2 = (_c = curMaster.value) == null ? void 0 : _c.id) != null ? _a2 : 0,
          "cur-user": unref(curUser),
          class: "w-full mb-4 fixed bottom-0 left-0 px-4",
  ...
  setup(__props) {
    ...
    const getSupplies = async () => {
      try {
        ...
        suppliesFilters.value = data.filters || [];
    ...
    const calcTotals = (ids) => {
      ...
      const datas = suppliesFilters.value.uniqueCategories.map((c) => {
        const items = supplies.value.flatMap((s) => s.positions).filter((s) => s.category === c);
        const uniqueItems = Object.values(
          items.reduce((acc, { name, priceForItem, quantity }) => {
            if (!acc[name]) {
              acc[name] = {
                name,
                quantity: 0,
            ...
            acc[name].price += priceForItem * quantity;
            return acc;
          }, {})
        );
        const totalPrice2 = uniqueItems.reduce((sum, item) => sum + item.price, 0);
        return {
          title: c,
          totalPrice: totalPrice2,
          items: uniqueItems.sort((a, b) => b.price - a.price)
        };
      });
      info.value = datas.sort((a, b) => b.totalPrice - a.totalPrice);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiCardDescription = _sfc_main$m;
      const _component_UiCardTitle = _sfc_main$1$3;
      const _component_UiScrollArea = _sfc_main$j;
      const _component_UiCardContent = _sfc_main$n;
      const _component_UiSeparator = _sfc_main$o;
      const _component_MySuppliesCreate = _sfc_main$4$2;
      ...
      const _component_UiDialogTitle = _sfc_main$1$5;
      const _component_UiDialogDescription = _sfc_main$q;
      const _component_MySuppliesEdit = _sfc_main$r;
      const _component_UiDialogFooter = _sfc_main$s;
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex gap-3 w-full"><div class="w-[500px] h-[calc(100vh-130px)] overflow-hidden rounded-md shrink-0">`);
      _push(ssrRenderComponent(_component_UiCard, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UiCardHeader, { class: "p-3 pb-2 text-right" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_UiScrollArea, { class: "h-[calc(100vh-180px)]" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UiCardContent, { class: "pt-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UiSeparator, null, null, _parent4, _scopeId3));
                        _push4(`<!--[-->`);
                        ssrRenderList(unref(info), (item) => {
                          _push4(`<div${_scopeId3}><div class="font-bold flex justify-between"${_scopeId3}><span${_scopeId3}>${ssrInterpolate(item.title)}</span><span${_scopeId3}>${ssrInterpolate(("useMyFormatPrice" in _ctx ? _ctx.useMyFormatPrice : unref(useMyFormatPrice))(+item.totalPrice.toFixed(2)))}\u20BD </span></div><ul class="mb-3"${_scopeId3}><!--[-->`);
                          ssrRenderList(item.items, (it, i) => {
                            _push4(`<li class="flex items-center"${_scopeId3}><span${_scopeId3}>${ssrInterpolate(it.name)}</span><div class="flex items-center ml-auto"${_scopeId3}><span class="whitespace-nowrap"${_scopeId3}>${ssrInterpolate(("useMyFormatPrice" in _ctx ? _ctx.useMyFormatPrice : unref(useMyFormatPrice))(it.price))}\u20BD</span><span class="text-xs"${_scopeId3}>(${ssrInterpolate(it.quantity)}\u0435\u0434.)</span></div></li>`);
                          });
                          _push4(`<!--]-->`);
                          _push4(ssrRenderComponent(_component_UiSeparator, null, null, _parent4, _scopeId3));
                          _push4(`</ul></div>`);
                        ...
                        return [
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(info), (item) => {
                            return openBlock(), createBlock("div", {
                              key: item.title
                            }, [
                              createVNode("div", { class: "font-bold flex justify-between" }, [
                                createVNode("span", null, toDisplayString(item.title), 1),
                                createVNode("span", null, toDisplayString(("useMyFormatPrice" in _ctx ? _ctx.useMyFormatPrice : unref(useMyFormatPrice))(+item.totalPrice.toFixed(2))) + "\u20BD ", 1)
                              ]),
                              createVNode("ul", { class: "mb-3" }, [
                                (openBlock(true), createBlock(Fragment, null, renderList(item.items, (it, i) => {
                                  return openBlock(), createBlock("li", {
                                    key: i,
                                    class: "flex items-center"
                                  }, [
                                    createVNode("span", null, toDisplayString(it.name), 1),
                                    createVNode("div", { class: "flex items-center ml-auto" }, [
                                      createVNode("span", { class: "whitespace-nowrap" }, toDisplayString(("useMyFormatPrice" in _ctx ? _ctx.useMyFormatPrice : unref(useMyFormatPrice))(it.price)) + "\u20BD", 1),
                                      createVNode("span", { class: "text-xs" }, "(" + toDisplayString(it.quantity) + "\u0435\u0434.)", 1)
                                    ])
                                  ]);
                                }), 128)),
                                createVNode(_component_UiSeparator)
                  ...
                  return [
                    createVNode(_component_UiCardContent, { class: "pt-2" }, {
                      default: withCtx(() => [
                        createVNode(_component_UiSeparator),
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(info), (item) => {
                          return openBlock(), createBlock("div", {
            ...
            return [
              createVNode(_component_UiCardHeader, { class: "p-3 pb-2 text-right" }, {
                default: withCtx(() => [
                  createVNode(_component_UiCardDescription, null, {
                    default: withCtx(() => [
                      createTextVNode("\u041E\u0431\u0449\u0430\u044F \u0441\u0443\u043C\u043C\u0430")
              ...
              createVNode(_component_UiScrollArea, { class: "h-[calc(100vh-180px)]" }, {
                default: withCtx(() => [
                  createVNode(_component_UiCardContent, { class: "pt-2" }, {
                    default: withCtx(() => [
                      createVNode(_component_UiSeparator),
      ...
      _push(`</div><div class="min-w-[1050px] overflow-hidden"><div class="flex gap-2 items-center mb-2"><div class="w-[330px]">`);
      _push(ssrRenderComponent(unref(Qn), {
      ...
      _push(ssrRenderComponent(_component_MySuppliesCreate, {
        suppliers: unref(suppliers),
        "positions-list": unref(positionsList),
        onSupplieCreated: async () => {
          await getSupplies();
          await getSuppliers();
        }
      }, null, _parent));
      _push(`</div><div class="mt-[-42px]">`);
      _push(ssrRenderComponent(_component_MySuppliesDataTable, {
        key: unref(supplies).length,
        data: unref(supplies),
        columns: unref(suppliesColumns),
        filters: unref(suppliesFilters),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_MySuppliesEdit, {
                    key: unref(editingSupplie).id,
                    suppliers: unref(suppliers),
                    supplie: unref(editingSupplie),
                    "positions-list": unref(positionsList),
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="flex flex-col gap-2"><div class="flex gap-2 items-center">`);
      _push(ssrRenderComponent(_component_UiTabs, {
        modelValue: sortTab.value,
        "onUpdate:modelValue": ($event) => sortTab.value = $event
      }, {
      ...
      if (unref(curUser)) {
        _push(ssrRenderComponent(_component_MyProductionCreateMasterReport, {
          "master-id": (_a2 = (_a = _ctx.currentMaster) == null ? void 0 : _a.id) != null ? _a2 : 0,
          "cur-user": unref(curUser),
          class: "w-full",
      ...
      _push(`</div><div class="w-full rounded-lg p-2 border border-slate-200 bg-white text-slate-950 shadow-sm dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50"><div class="flex justify-between"><span> \u042D\u043B-\u0442\u044B: ${ssrInterpolate(totalEls.value)}</span><span> \u0421\u0443\u043C\u043C\u0430: ${ssrInterpolate(totalCost.value)}\u0440. </span></div></div></div></div>`);
      if (isLoading.value) {
        _push(`<div class="text-center">\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...</div>`);
      } else if (error.value) {
        _push(`<div class="text-red-500 text-center">${ssrInterpolate(error.value)}</div>`);
                    ...
                    _push3(ssrRenderComponent(_component_UiTableCaption, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        ...
                        if (_push4) {
                          ...
                          return [
                            createTextVNode("\u041E\u0442\u0447\u0435\u0442\u044B \u043C\u0430\u0441\u0442\u0435\u0440\u0430: " + toDisplayString((_b = props.currentMaster) == null ? void 0 : _b.fullName), 1)
                          ];
                        }
                      }),
                      _: 1
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiSheetTrigger = _sfc_main$4$4;
      const _component_UiSheetContent = _sfc_main$3$4;
      const _component_UiSheetHeader = _sfc_main$2$5;
      const _component_UiSheetTitle = _sfc_main$1$6;
      const _component_UiSheetDescription = _sfc_main$t;
  ...
  setup(__props, { emit: __emit }) {
    ...
    watch(
      ...
      () => {
        ...
        calculateCost();
        if (((_a = props.curUser) == null ? void 0 : _a.role.shortName) === "PACKER") {
          disabled.value = !(date && name && (items || adapters || lam || dimmers));
        } else {
          disabled.value = !(date && name);
        }
      },
      { deep: true }
    );
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                              ...
                              if (((_a = _ctx.curUser) == null ? void 0 : _a.role.shortName) !== "PACKER") {
                                ...
                                _push5(ssrRenderComponent(_component_UiInput, {
                                  modelValue: newReportPacker.value.penaltyCost,
                                  "onUpdate:modelValue": ($event) => newReportPacker.value.penaltyCost = $event,
                                  placeholder: "\u0428\u0442\u0440\u0430\u0444",
                                  type: "number"
                                }, null, _parent5, _scopeId4));
                                _push5(`</div><div class="relative"${_scopeId4}>`);
                                _push5(ssrRenderComponent(_component_UiTextarea, {
                                  modelValue: newReportPacker.value.comment,
                                  "onUpdate:modelValue": ($event) => newReportPacker.value.comment = $event,
                                  placeholder: "\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439"
                                }, null, _parent5, _scopeId4));
                                if (newReportPacker.value.comment) {
                                  _push5(ssrRenderComponent(_component_UiLabel, { class: "font-medium text-slate-400 absolute left-2 top-[-13px] bg-white rounded-md p-1 whitespace-nowrap" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(` \u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439 `);
                              ...
                              _push5(`<span${_scopeId4}> \u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C: ${ssrInterpolate(newReportPacker.value.cost)}\u0440. </span></div><div class="flex justify-between w-full"${_scopeId4}>`);
                              _push5(ssrRenderComponent(_component_UiButton, {
                                disabled: disabled.value,
                              ...
                              return [
                                createVNode("div", { class: "flex flex-col gap-5" }, [
                                  ...
                                  ((_b = _ctx.curUser) == null ? void 0 : _b.role.shortName) !== "PACKER" ? (openBlock(), createBlock("div", {
                                    key: 0,
                                    class: "flex flex-col gap-2"
                                  }, [
                                    createVNode("div", { class: "relative" }, [
                                    ...
                                    createVNode("div", { class: "relative" }, [
                                      ...
                                      newReportPacker.value.comment ? (openBlock(), createBlock(_component_UiLabel, {
                                        key: 0,
                                        class: "font-medium text-slate-400 absolute left-2 top-[-13px] bg-white rounded-md p-1 whitespace-nowrap"
                                      }, {
                                        default: withCtx(() => [
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="flex items-center gap-2"><div class="min-w-[200px]">`);
      _push(ssrRenderComponent(unref(Qn), {
        modelValue: date.value,
      ...
      _push(`</div><div class="w-full rounded-lg p-2 border border-slate-200 bg-white text-slate-950 shadow-sm dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50"><div class="flex justify-end"><span> \u0421\u0443\u043C\u043C\u0430: ${ssrInterpolate(totalCost.value)}\u0440. </span></div></div></div></div>`);
      if (isLoading.value) {
        _push(`<div class="text-center">\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...</div>`);
      } else if (error.value) {
        _push(`<div class="text-red-500 text-center">${ssrInterpolate(error.value)}</div>`);
        ...
        _push(`<div>`);
        _push(ssrRenderComponent(_component_UiScrollArea, { class: "h-[calc(100vh-275px)] rounded-sm" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UiTable, { class: "bg-white rounded-sm relative" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        ...
                                        if (report.name.startsWith("http")) {
                                          ...
                                          _push6(`<div class="flex flex-col text-wrap text-gray-600"${_scopeId5}><span${_scopeId5}>${ssrInterpolate(report.name)}</span></div>`);
                                        }
                                        ...
                                        return [
                                          createVNode("div", { class: "flex flex-col items-center" }, [
                                            report.name.startsWith("http") ? (openBlock(), createBlock("a", {
                                              ...
                                              key: 1,
                                              class: "flex flex-col text-wrap text-gray-600"
                                            }, [
                                              createVNode("span", null, toDisplayString(report.name), 1)
                                            ])),
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="flex gap-2 items-center">`);
      _push(ssrRenderComponent(_component_MyProductionCreatePackerReport, {
      ...
      _push(`<div class="w-full rounded-lg p-2 border border-slate-200 bg-white text-slate-950 shadow-sm dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50"><span> \u0421\u0443\u043C\u043C\u0430: ${ssrInterpolate(unref(totalCost))}\u0440. </span></div></div>`);
      if (unref(isLoading)) {
        _push(`<div class="text-center">\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...</div>`);
      } else if (unref(error)) {
                    ...
                    _push3(ssrRenderComponent(_component_UiTableCaption, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        ...
                        if (_push4) {
                          ...
                          return [
                            createTextVNode("\u041E\u0442\u0447\u0435\u0442\u044B \u0443\u043F\u0430\u043A\u043E\u0432\u0449\u0438\u043A\u0430: " + toDisplayString((_b = _ctx.curentPacker) == null ? void 0 : _b.fullName), 1)
                          ];
                        }
                      }),
                      _: 1
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        ...
                                        if (report.name.startsWith("http")) {
                                          ...
                                          _push6(`<div class="flex flex-col text-wrap"${_scopeId5}><span${_scopeId5}>${ssrInterpolate(report.name)}</span></div>`);
                                        }
                                        if (report.dopsComment) {
                                          _push6(`<span class="text-wrap text-gray-600"${_scopeId5}> + ${ssrInterpolate(report.dopsComment)}</span>`);
                                        } else {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LayoutSidebar = _sfc_main$g;
      const _component_UiTabs = _sfc_main$2$1;
      const _component_UiTabsList = _sfc_main$h;
      const _component_UiTabsTrigger = _sfc_main$1$1;
      const _component_MyProductionOrdersList = _sfc_main$b;
      ...
      _push(`</div><div class="h-[full] flex px-4 gap-2 mx-[auto] max-w-[2048px] pt-16"><div class="flex flex-col gap-2 w-full"><div class="flex gap-2"><div class="w-[180px]">`);
      _push(ssrRenderComponent(unref(Qn), {
      ...
      _push(`</div>`);
      if (unref(curTab) === "orders") {
        _push(`<div>`);
        _push(ssrRenderComponent(_component_MyProductionOrdersList, {
          key: unref(period),
          period: unref(period)
        }, null, _parent));
        _push(`</div>`);
...
//# sourceMappingURL=index-PB0d2kgX.mjs.map
